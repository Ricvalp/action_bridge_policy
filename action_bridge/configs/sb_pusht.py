...
def get_config(method="ddim"):
    ...
    return dict(protocol=PROTOCOL, method=method, seed=0,
                ...
                training_blocks=4, source_self_probabilities=[.10, .50, 1., 1.],
                source_seed=17, source_producer="own_forward_ema_snapshot",
                startup="observed_anchor_repeat", external_bootstrap=False,
